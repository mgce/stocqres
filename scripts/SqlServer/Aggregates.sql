...
IF NOT EXISTS(SELECT * FROM sysobjects  WHERE name = 'BuyOrderEvents' AND xtype='U')
CREATE TABLE [Customers].[BuyOrderEvents](
[Id] UNIQUEIDENTIFIER default NEWID() NOT NULL,
[AggregateId] UNIQUEIDENTIFIER NOT NULL,
[AggregateType] NVARCHAR(255) NOT NULL,
[Version] INT NOT NULL,
...
[MetaData] NVARCHAR(MAX) NOT NULL,
[CreatedAt] DATETIME NOT NULL,
CONSTRAINT PKBuyOrderEvents PRIMARY KEY(ID)
)
GO

IF NOT EXISTS(SELECT * FROM sysobjects  WHERE name = 'SellOrderEvents' AND xtype='U')
CREATE TABLE [Customers].[SellOrderEvents](
[Id] UNIQUEIDENTIFIER default NEWID() NOT NULL,
[AggregateId] UNIQUEIDENTIFIER NOT NULL,
[AggregateType] NVARCHAR(255) NOT NULL,
[Version] INT NOT NULL,
...
[MetaData] NVARCHAR(MAX) NOT NULL,
[CreatedAt] DATETIME NOT NULL,
CONSTRAINT PKSellOrderEvents PRIMARY KEY(ID)
)
GO
